...
TEXTURE2D(_SmoothnessGlossMap); SAMPLER(sampler_SmoothnessGlossMap);
...
{
    half smoothness;
#ifdef _SMOOTHNESSGLOSSMAP
    smoothness = SAMPLE_TEXTURE2D(_SmoothnessGlossMap, sampler_SmoothnessGlossMap, uv).r;
#else
