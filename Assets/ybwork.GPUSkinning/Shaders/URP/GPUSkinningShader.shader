...
Shader "ybwork/GPUSkinningShader/URP"
{
    Properties
    {
        ...
        _SmoothnessGlossMap("Smoothness", 2D) = "white" {}
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature_local_fragment _SMOOTHNESSGLOSSMAP
        ...
        Pass
        {
            ...
            #include "LitInput.hlsl"
            #include "LitForwardPass.hlsl"
            void ShadowPassFragment(Varyings input, out half4 outColor : SV_Target0
