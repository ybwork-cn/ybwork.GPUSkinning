    ...
    void Start()
    {
        ...
        for (int i = 0; i < 50; i++)
        {
            for (int j = 0; j < 60; j++)
            {
                ...
                gpuSkinningComponent.StateMachine.RegisterLoopState(0);
                gpuSkinningComponent.StateMachine.RegisterOnceState(1, 0);
                gpuSkinningComponent.StateMachine.RegisterLoopState(2);
